...
namespace Services.Managers
{
    public class Case6Manager
    {
            ...
            foreach (UnevaluatedObject uo in semiSecurityObjects)
            {
                ...
                foreach (OwnedMethod om in directlyAffectedMethods)
                    ...
                    foreach (CalledByMethod cbm in om.CalledByMethods)
                        FindCase6Criteria2Objects(Global, semiSecurityObjects, cbm);
            }
        }

        /// <summary>
        /// Find case 6 criteria 2 objects and add them to the list
        /// </summary>
        private void FindCase6Criteria2Objects(Global Global, IEnumerable<UnevaluatedObject> semiSecurityObjects, CalledByMethod cbm)
        {
        ...
        /// <summary>
        /// Find Case6 objects and add them to the list
        /// </summary>
        private void FindCase6Object(Global Global, CalledByMethod cmm)
        {
        ...
        /// <summary>
        /// Iterate through case6 objects.
        /// </summary>
        private void Case6Iterator(Global Global, CalledByMethod cm)
        {
